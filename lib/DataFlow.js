...
define([
    ...
    DataFlow.prototype.connect = function(from, to){
        // TODO
        // new args , fromKeys, toKeys
        // If there are mapping paramenters passed they need to be validated
        // lengths of the arrays have to equal
        // the keys have to be valid inputs and outputs from the defined functions
        // there can't be someting already mapped to the input of the to function
        this._prepareForUpdate();
